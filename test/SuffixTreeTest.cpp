...
TEST(SuffixTree, Test_1)
{
    ...
    SuffixTree tree3 = std::move(tree);
...
TEST(SuffixTree, Test_2)
{
    SuffixTree tree = {"abde", "abc", "b", "abd", "b"}; // last "b" element won't affect tree
    ...
    SuffixTree tree2(std::cbegin(array), std::cend(array));
