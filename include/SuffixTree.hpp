...
namespace container
{
    ...
    public :
        ...
        SuffixTree(std::initializer_list<std::string_view> initList)
        {
        ...
        SuffixTree(InputIterator begin, InputIterator end)
        {
            for (; begin != end; ++begin)
            {
                insert(*begin);
        ...
        friend inline bool operator==(
            const SuffixTree& lhs, const SuffixTree& rhs) noexcept
        {
